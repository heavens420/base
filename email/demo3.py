...
message = "测试 附件发送"
conent_apart = MIMEText(message, "plain", _charset="utf-8")

img_file = r"C:\workspace\python\w1\base\email\排序算法.jpg"
...
text_file = r"C:\workspace\python\w1\base\email\demo1.py"
