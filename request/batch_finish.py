...
def get_running_api() -> list:
    with open('txt/api_inst_list.txt', 'r', encoding='utf-8') as file:
...
def batch_restart_api():
    ...
    for api in api_list:
        ...
        # print(f'param:{param}')
        restart_url = r'http://134.95.222.252:18512/microservice/ae/handleResExp'
...
if __name__ == '__main__':
    path = r'txt/api_inst_list.txt'
    url = r'http://134.95.222.252:18519/microservice/apiDefine/faultIntelligentAnalysisCallbackApi'
    token = r'12bd2cf2c3d279bd2ef841bb43bcc85c'
    # batch_call_back()
    # finish_activity(jsonParam)
    # getCache()
    # setCache()
